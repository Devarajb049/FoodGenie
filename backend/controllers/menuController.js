...
exports.getAllMenus = catchAsync(async (req, res, next) => {
  console.log("=== INCOMING GET MENUS REQUEST ===");
  ...
  console.log("MongoDB Query Result Count:", menu ? menu.length : 0);
  console.log("MongoDB Query Result:", JSON.stringify(menu, null, 2));
