...
exports.signup = catchAsyncErrors(async (req, res, next) => {
    ...
    if (req.body.avatar) {
        if (typeof req.body.avatar === "string" && req.body.avatar !== "/images/images.png") {
            try {
                ...
                console.warn("Cloudinary upload failed, using string fallback:", err.message);
                avatar = {
                    public_id: "default_fallback",
                    url: req.body.avatar
                };
            }
        } else if (typeof req.body.avatar === "object") {
            avatar = {
                public_id: req.body.avatar.public_id || "default",
                url: req.body.avatar.url || "/images/images.png"
            };
        }
    }
